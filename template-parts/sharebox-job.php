...
<div class="apus-social-share share-blog">
		...
		<?php endif; ?>
			...
			<?php if ( superio_get_config('whatsapp_share', 1) ): ?>
	
			<a class="whatsapp" data-toggle="tooltip" data-original-title="WhatsApp" href="https://api.whatsapp.com/send?text=<?php echo urlencode(get_permalink()); ?>" target="_blank" title="<?php 					echo esc_html__('Share on WhatsApp', 'superio'); ?>">
    			<i class="fab fa-whatsapp"></i>
    			<?php echo esc_html__('WhatsApp', 'superio'); ?>
			</a>

		<?php endif; ?>
	
			<?php if ( superio_get_config('email_share', 1) ): ?>
	
			<a class="email" data-toggle="tooltip" data-original-title="Email" href="mailto:?subject=<?php echo urlencode(esc_html__('Check this out!', 'superio')); ?>&body=<?php echo urlencode(get_permalink()); ?>" target="_blank" title="<?php echo esc_html__('Share via Email', 'superio'); ?>">
    			<i class="fas fa-envelope"></i>
    			<?php echo esc_html__('Email', 'superio'); ?>
			</a>
