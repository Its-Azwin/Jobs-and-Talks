	...
	<div class="inner">
	    ...
	    <form id="job-apply-email-form-<?php echo esc_attr($post->ID); ?>" class="job-apply-email-form" method="post" action="" enctype="multipart/form-data">
	    	<div class="row">
			    ...
			    <div class="col-xs-12">
			        <div class="form-group">
			            <input type="text" class="form-control style2" name="phone" placeholder="<?php esc_attr_e( 'Phone', 'superio' ); ?>" required="required">
			        </div><!-- /.form-group -->
			    </div>
			    <div class="col-xs-12">
	        	...
	        	<?php if ( $cv_required == 'on' ) { ?>
			        <?php if ( is_array($cv_attachments) ) { ?>
				        <div class="col-xs-12">
					        ...
					        <div class="wrapper-file-action <?php echo trim( (count($cv_attachments) > 1)?'has-multiply':'' ); ?>" required="required">
					            <?php
					...
					<div class="col-xs-12">
				     	<div class="form-group upload-file-btn-wrapper">
				            <input type="file" class="cv_file" name="cv_file" data-file_types="<?php echo esc_attr(!empty($cv_types) ? implode('|', $cv_types) : ''); ?>" required="required">

				            <div class="label-can-drag">
								<div class="form-group group-upload">
							        <div class="upload-file-btn" data-text="<?php echo esc_attr(sprintf(esc_html__('Upload CV (%s)', 'superio'), $cv_types_str)); ?>" required="required">
